...
pub const TOOL_RELOAD_BUNDLE: &str = "skills.reload_bundle";
pub const TOOL_GENERATE_PROPOSAL_PACKET: &str = "skills.generate_proposal_packet";
pub const TOOL_STOP_SESSION: &str = "skills.stop_session";
pub const TOOL_CLEAR_STOP: &str = "skills.clear_stop";
pub const PROMPT_STATUS_SUMMARY: &str = "skills.session_status_summary";
pub const PROMPT_OWNER_GUIDANCE: &str = "skills.owner_guidance";
pub const PROMPT_PROPOSAL_PACKET: &str = "skills.proposal_packet";
pub const PROMPT_OPERATOR_GUIDANCE: &str = "skills.operator_guidance";
...
pub const TOOL_STRATEGY_SELECTION_MATERIALIZE: &str = "strategy_selection.materialize";
pub const TOOL_STRATEGY_SELECTION_APPLY_OVERRIDE: &str = "strategy_selection.apply_override";
pub const TOOL_STRATEGY_SELECTION_APPROVE: &str = "strategy_selection.approve";
...
pub const PROMPT_CURRENT_STEP_GUIDANCE: &str = "onboarding.current_step_guidance";
pub const PROMPT_FAILURE_SUMMARY: &str = "onboarding.failure_summary";
pub const PROMPT_ROUTE_READINESS_GUIDANCE: &str = "readiness.route_guidance";
pub const PROMPT_ROUTE_BLOCKER_SUMMARY: &str = "readiness.route_blocker_summary";
pub const PROMPT_STRATEGY_SELECTION_GUIDANCE: &str = "strategy_selection.guidance";
pub const PROMPT_STRATEGY_SELECTION_DISCUSSION: &str = "operator.strategy_selection_discussion";
pub const PROMPT_STRATEGY_SELECTION_RECOVERY: &str = "operator.strategy_selection_recovery";
...
pub const PROMPT_STRATEGY_OPERATOR_REPORT_GUIDANCE: &str =
    "operator.strategy_operator_report_guidance";
pub const PROMPT_STRATEGY_REPORT_WINDOW_GUIDANCE: &str = "operator.strategy_report_window_guidance";
